...
function Card({ fontSize, bgColor, header, rows, flex }) {
  return (
    <>
      <Flexc
      ...
      >
        ...
        <Flexc
          vcenter={true}
          center={true}
          className={`w-[180px] text-white h-full flex-col text-[1em]`}
        >
        ...
        {/* </PEMBATAS> */}
        <Flexc
          className={`min-w-[120px] text-white h-full flex-col rounded overflow-hidden text-[1em]`}
        >
          {rows.map((row, index) => (
