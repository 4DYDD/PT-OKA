  ...
  return (
    <>
      <div className="kotak--utama fixed left-[50%] top-[50%] z-20 flex h-[110vh] w-[100vw] translate-x-[-50%] translate-y-[-50%] cursor-wait flex-col justify-center transition-all duration-500 ease-in-out">
        <div className="kotak--wan relative bg-primary h-[250px] flex justify-start items-center overflow-hidden">
          {/* <LOGONYA> */}
          <div className="relative flex items-center justify-center w-[200px]">
            <div class="relative buletan circle-container w-[150px] h-[150px] text-[1em] overflow-hidden bg-primary flex justify-center items-center rounded-full">
          ...
          <div className="garis--tri bg-white w-[4px] relative rounded-full"></div>

          <div className="relative text--wan flex items-center justify-start flex-1 text-[3rem] text-white overflow-hidden h-full">
